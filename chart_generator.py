...
def main(argv=None):
    ...
    parser.add_argument("--nashville", action="store_true", help="Convert to Nashville numbers")
    parser.add_argument("--input-key", help="Key of the input chart (overrides auto-detection, e.g., Eb)")
